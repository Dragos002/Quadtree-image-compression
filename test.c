...
// void vector (node *root, qnode *v, int n, int *i, int arr)
// {   
//     v[*i].red = root->red;
//     v[*i].blue=root->blue;
//     v[*i].green=root->green;
//     if(*i == 0)
//         v[*i].area = n*n;
//     v[*i].area = (n*n)/pow(4, arr);
//     if (root->first != NULL)
//          {v[*i].top_left = root->first->nr;
//          *i=*i+1;
//          arr++;
//          vector(root->first,v,n,i,arr);}
//          else
//          {
//              v[*i].top_left = -1;
//          }
//     if (root->second != NULL)
//         {v[*i].top_right = root->second->nr;
//         *i=*i+1;
//         arr++;
//         vector(root->second,v,n,i,arr);}
//         else
//         {
//             v[*i].top_right = -1;
//         }
//     if (root->forth != NULL)
//         {v[*i].bottom_left= root->forth->nr;
//         *i=*i+1;
//         arr++;
//         vector(root->forth,v,n,i,arr);}
//         elseif(*i == 0)
//         v[*i].area = n*n;
//     v[*i].area = (n*n)/pow(4, arr);
//     if (root->first != NULL)
...
//         }
//     if (root->third != NULL)
//         {v[*i].bottom_right = root->third->nr;
//         *i=*i+1;
//         arr++;
//         vector(root->third,v,n,i,arr);}
//         else
//         {
//             v[*i].bottom_right = -1;
//         }
